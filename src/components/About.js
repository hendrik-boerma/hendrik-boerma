...
function About (){
    return (
        <section className='py-12 px-6 flex flex-col items-center md:flex-row md:gap-12 md:px-16' id='section1'>
          <div className='leading-loose rounded-r-2xl sm:w-full md:w-5/12'>
            ...
            <p className='text-offwhite text-justify'>Ik ben Hendrik Boerma en ik ben Agile test engineer bij Sogeti(Part of Capgemini) en momenteel in opdracht bij de gemeente Groningen. 
